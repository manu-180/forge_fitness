...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  brand: {
    name: "Fitness Live Gym",
    wordPrimary: "FITNESS",
    wordSecondary: "LIVE",
    navShort: "FITNESS LIVE",
    logoLetter: "F",
    taglineShort:
      "Musculación premium. Coaches certificados, entrenamientos personalizados y rutina digital. Sin excusas, resultados reales.",
    instagramHandle: "fitnesslivegym",
    locationLabel: "Argentina",
  },
  seo: {
    title: "Fitness Live Gym — Musculación y Entrenamiento Premium",
    description:
      "Gimnasio de musculación con coaches certificados. Entrenamientos personalizados, preparación física integral, stretching y pilates. Rutina digital sin costo.",
    siteName: "Fitness Live Gym",
    keywords:
      "gimnasio, musculación, personal trainer, preparación física, pilates, stretching, entrenamiento personalizado, fitness",
    ogImageUrl: "",
    indexable: true,
  },
  contact: {
    addressLines: "Consultanos por la dirección",
    phoneDisplay: "Reservá por WhatsApp",
    email: "hola@fitnesslivegym.com",
    emailDisplay: "hola@fitnesslivegym.com",
    hoursLines: "Lun a Vie: 8:00–22:00\nSábados: 10:00–15:00",
    mapsSearchQuery: "Fitness Live Gym",
    whatsappPhoneDigits: "5491100000000",
  },
  assets: {
  ...
  hero: {
    eyebrowLeft: "Musculación · Personal Trainers",
    eyebrowRight: "No Excuses · Just Results",
    categoryLine: "Gimnasio de Musculación — Entrenamiento Premium",
    titleLine1: "FITNESS",
    titleLine2: "LIVE",
    subtitle:
      "Sala de musculación, entrenamientos personalizados y planes específicos con profes certificados. Rutina digital incluida sin costo.",
  },
  preloader: {
    subline: "Entrená en vivo. Entrená mejor.",
  },
